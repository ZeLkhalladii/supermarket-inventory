...
--
-- Hôte : localhost
-- Généré le :  sam. 02 mai 2020 à 13:45
...
CREATE TABLE `fournisseurs` (
  ...
  `Frs_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Société` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Ayoub', 'jawda', 'bloc 5', 645342387, 'jawda-safi@support.com'),
(2, 'Youssef', 'jawda', 'bloc 5', 645342387, 'bimo-safi@support.com');
...
CREATE TABLE `produits` (
  ...
  `produit_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `rayons` (
  `Rayon_id` int(11) NOT NULL,
  `Rayon_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `rayons`
  MODIFY `Rayon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
